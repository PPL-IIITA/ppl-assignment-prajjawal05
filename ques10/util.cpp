  ...
  public:
      int coupling(int k)
      {
        ...
        for(int i=0;i<ng;i++)
	      ...
	      kbest<boys> kboys; //!Template returning besst valued boys according to their budget.
        kbest<girls> kgirls;
       ...
       int gifting(int k)
       {
         ...
         //for(int i=0;i<ngf;i++)
         cout<<"---------- GIFTINGS ------------"<<endl;
         cc.couplegifting(couple,count,gif,k); //!Gift exchanges,happiness and compatibility calculation and inserting into log file and fcalc.txt.
         return 0;
       }
};
